...
> 运维升级，当前升级计划6个月，于2023年三季度完成整个工作

主要升级部分，集成运维和容器化管理，形成统一的运维平台

- 集成容器化管理平台，集成k8s运维管理平台，整体服务迁移k8s进行管理
- 集成安全触感服务，进行DevOpsSec和应用日志分析、代码分析、登陆安全等多渠道的安全处理（主要基于现有数据中台进行分析优化）
- 进一步升级和优化数据中台相关的服务和组件，进一步的升级管理服务组件，达到更好用的目标
- 集成统一的运维管理门户，形成统一的运维管理平台
- 进一步优化云平台管理门户，进一步优化使用集成体验

研究部分：

- 集成ChatOps的研究和集成尝试，目标是一个平台一个入口，计划于2.1.4版本集成
